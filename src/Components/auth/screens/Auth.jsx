    ...
    <div className='Wrapper'>
      <div className='Center'>
        <h1>Welcome to Qrit</h1>
            <div className='Selec'>
              <label className='Rbtn'><input type="radio" name="auth" value="signup" checked={auth === 'signup'} onChange={handleChange} /> Sign up</label>
              <br></br>
              <label className='Rbtn'><input type="radio" name="auth" value="signin" checked={auth === 'signin'} onChange={handleChange}/> Login</label>
